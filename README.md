...
<h1 align="center">Price change alerts poc</h1>
...
- `NODEMAILER_CONFIG` (optional, if using nodemailer **only**) JSON stringified nodemailer config. eg. `{"service":"Gmail","auth":{"user":"myusername@gmail.com","pass":"myapppassword"}}` (also make sure to enable app passwords from your account https://myaccount.google.com/apppasswords)

They can be added locally via the `.env.local` file.
